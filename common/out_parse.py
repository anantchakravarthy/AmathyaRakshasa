...
usage: python AmathyaRakshasa.py --help

{Fore.BLUE}A---m---a---t---h---y---a---R---a---k---s---h---a---s---a
|   |   |   |   |   |   |   |   |   |   |   |   |   |   |
a---M---A---T---H---Y---A---r---A---K---S---H---A---S---A{Fore.GREEN})
...
In essence, AmathyaRakshasa transcends being a mere tool; it stands as a tribute to the intellectual might and strategic ingenuity of Amathya Rakshasa, reimagined for today's digital frontier to safeguard cyberspace realms. </p> </div>"""
        ...
        html += """<footer><h4>Thank You for using AmathyaRakshasa!</h4><ul style="list-style: none;"><li style="margin-top:10px;">Give us star: <a href="">https://github.com/anantchakravarthy/AmathyaRakshasa</a></li></ul></footer><script src="https://code.jquery.com/jquery-3.7.1.min.js"></script><script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.js"></script><script>$(document).ready( function () {$('#exploitdb').DataTable();$('#exploitalert').DataTable();$('#packetstorm').DataTable();$('#nvddb').DataTable();$('#msfmodule').DataTable();} );</script></body></html>"""
